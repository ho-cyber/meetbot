      ...
      <div className="container">
        <div className="md:flex items-center">
          <div className="md:w-[478px]">
            <div className="tag">Enroll Now for 2024!</div>
            <h1 className="text-5xl md:text-7xl font-bold tracking-tigher bg-gradient-to-b from-black to-[#001e80] text-transparent bg-clip-text mt-6">
              Ignite Your Child's Passion for Math and Science
            </h1>
            <p className="text-xl text-[#010d3e] tracking-tight mt-6">
              Join our after-school programs designed to enhance your child's understanding of math and science through engaging activities and expert guidance.
            </p>
